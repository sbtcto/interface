...
NioApp = (function(NioApp, $, window) {
    ...
    var $chart = $('.chart-data'),
        $chart_s2 = $('.chart-data-s2'),
        $chart_s1 = $('.chart-data-s1');
                    ...
                    options: {
                        ...
                        hover: {
                            onHover: function(e, i) {
                                if (i.length) {
                                    var _cur_idx = i[0]._index + 1,
                                        _self_can = i[0]._chart.canvas.id;
            ...
            if ($('#' + _canvas).length) {
                ...
                var data_set = {
                    ...
                    datasets: [{
                        label: "949",
                        lineTension: 0,
                        backgroundColor: '#171f57',
                        hoverBackgroundColor: '#ff8d00',
                        borderColor: _canvas_border,
                        borderWidth: 2,
                        hoverBorderColor: _canvas_border,
                        data: _amounts,
